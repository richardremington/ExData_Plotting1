...
plot( d$date.time, d$global_active_power, type="n",
      xlab = "",
      ylab = "Global Active Power")
lines( d$date.time, d$global_active_power)

#-- panel 1, 2

plot( d$date.time, d$voltage, type="n",
      xlab = "datetime",
      ylab = "Voltage")
lines( d$date.time, d$voltage)
...
plot( d$date.time, d$global_reactive_power, type="n",
      xlab = "datetime",
      ylab = "Global_reactive_power",
      yaxt = "n")
lines( d$date.time, d$global_reactive_power)
box()
